      ...
      <div className="hidden lg:flex lg:w-1/2 bg-card flex-col justify-between p-12 relative overflow-hidden border-r border-border/50">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col gap-6 max-w-lg">
            ...
            <p className="text-muted-foreground text-lg">
              Access exclusive entertainment investment opportunities with transparent terms and real-time portfolio management.
            </p>
          </div>
        </div>
        ...
        <div className="relative z-10 flex flex-col gap-4">
          <div className="flex items-center gap-4 p-4 bg-background rounded-xl border border-border/50 hover:border-border transition-colors">
            ...
            <div>
              <p className="font-semibold text-foreground">Simple Account Setup</p>
          ...
          <div className="flex items-center gap-4 p-4 bg-background rounded-xl border border-border/50 hover:border-border transition-colors">
            ...
            <div>
              <p className="font-semibold text-foreground">Secure KYC Verification</p>
          ...
          <div className="flex items-center gap-4 p-4 bg-background rounded-xl border border-border/50 hover:border-border transition-colors">
            ...
            <div>
              <p className="font-semibold text-foreground">Instant Deal Access</p>
              <p className="text-sm text-muted-foreground">Start browsing deals immediately</p>
            </div>
          </div>
        </div>
